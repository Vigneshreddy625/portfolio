...
export default function Projects({ id }) {
  ...
  const content = [
    ...
    <div
      className="lg:hidden h-[30rem] md:h-[40rem] [perspective:1000px] relative b flex flex-col max-w-sm md:max-w-5xl mx-auto w-full  items-start justify-start my-10">
      <Tabs tabs={tabs} />
    </div>
      </section>
    );
